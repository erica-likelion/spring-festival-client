...
import Logo from '@/assets/images/hylight-likelion.svg';
    ...
    <S.Container>
      ...
      <S.TextWrap>
        ...
        <S.SubTitle>
          ...
          협업했습니다. 축제의 설렘을 어플 속에 고스란히 담아냈습니다. 지금 여러분께 우리의 결과물을
          자신 있게 소개합니다!
        </S.SubTitle>
      </S.TextWrap>
      <S.MockUp>목업</S.MockUp>
      <S.PartWrap>
        {parts.map((part) => {
            ...
            <S.PartBox key={part}>
              ...
              <S.PartCard>
                {members.map((member, index) => (
                  <Card key={index} {...member} image={member.image.TestImage} />
                ))}
              </S.PartCard>
            </S.PartBox>
          );
